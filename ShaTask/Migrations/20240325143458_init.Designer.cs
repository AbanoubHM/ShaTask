...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShaTask.DbModels.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShaTask.DbModels.Cashier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShaTask.DbModels.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShaTask.DbModels.InvoiceDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ShaTask.DbModels.InvoiceHeader", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ShaTask.DbModels.Branch", b =>
                {
                    b.HasOne("ShaTask.DbModels.City", "City")
                        .WithMany("Branches")
            ...
            modelBuilder.Entity("ShaTask.DbModels.Cashier", b =>
                {
                    b.HasOne("ShaTask.DbModels.Branch", "Branch")
                        .WithMany("Cashiers")
            ...
            modelBuilder.Entity("ShaTask.DbModels.InvoiceDetail", b =>
                {
                    b.HasOne("ShaTask.DbModels.InvoiceHeader", "InvoiceHeader")
            ...
            modelBuilder.Entity("ShaTask.DbModels.InvoiceHeader", b =>
                {
                    ...
                    b.HasOne("ShaTask.DbModels.Cashier", "Cashier")
                        .WithMany("InvoiceHeaders")
